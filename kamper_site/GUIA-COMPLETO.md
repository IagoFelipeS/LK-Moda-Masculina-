...
**Problema:** Produtos podiam depender de dados locais e não refletir o Firebase
**Solução:** Produtos agora vêm somente do Firebase, com listener em tempo real
...
- Produtos não são salvos fora do Firebase
- Verifique conexão, login admin e regras do Firestore
- Refaça a ação quando o Firebase estiver online
